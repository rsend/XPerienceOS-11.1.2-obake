...
-include vendor/XPe/config/BoardConfigCM.mk
...
# The in-tree MCLinker FlexLexer.h requires the 2.5.39 C++ scanner API.
# Keep the historical binary's locale-dependent lexer generation in C locale.
LEX := env LC_ALL=C prebuilts/misc/linux-x86/flex/flex-2.5.39
# Build the required Bison 2.7 from external/bison as a host tool.
...
include vendor/XPe/build/core/qcom_target.mk

# Rules for MTK targets
include vendor/XPe/build/core/mtk_target.mk
...
$(eval include vendor/XPe/sepolicy/sepolicy.mk)
