...
# Obake SU6-7.3 has LTE voice calibration rows omitted by the older common
# loader. Product-local copies precede inherited common destinations (first
# destination wins in build/core/Makefile). Do not test TARGET_DEVICE here:
# product_config.mk assigns it only after product inheritance is resolved.
PRODUCT_COPY_FILES += \
    device/motorola/msm8960dt-common/audio-su6-73/libacdbloader.so:system/lib/libacdbloader.so
