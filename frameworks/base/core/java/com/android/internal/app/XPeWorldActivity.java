...
public class XPeWorldActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logo.setImageResource(com.android.internal.R.drawable.xpe_world_logo);
        ...
        logo.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                try {
                    ...
                    android.util.Log.e("XPeWorldActivity", "Couldn't catch a break.");
                }
                finish();
                return true;
            }
