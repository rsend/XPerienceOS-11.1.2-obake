...
# Opt-in for Motorola's integrated-modem, per-session mixer ABI.
ifeq ($(strip $(AUDIO_FEATURE_ENABLED_MSM8960_LEGACY_VOICE)),true)
    LOCAL_CFLAGS += -DMSM8960_LEGACY_VOICE
endif
